--Criando e usando banco de dados SP Medical Group
CREATE DATABASE SPMEDGROUP_MANHA

USE SPMEDGROUP_MANHA

--Criando tabelas sem dependência de outras tabelas
...
CREATE TABLE METODOS_TERAPEUTICOS (
	MetodoId INT IDENTITY PRIMARY KEY
	,
	MetodoNome VARCHAR(250) NOT NULL UNIQUE
);
...
CREATE TABLE GENEROS (
	...
	,
	GeneroNome VARCHAR(50) NOT NULL UNIQUE
);
...
CREATE TABLE MEDICOS (
	...
	,
	IdMedicoMetodo INT FOREIGN KEY REFERENCES METODOS_TERAPEUTICOS(MetodoId)
);
...
CREATE TABLE PRONTUARIOS (
	...
	,
	IdProntuarioGenero INT FOREIGN KEY REFERENCES GENEROS(GeneroId)
	,
	Altura VARCHAR(10)
	,
...
CREATE TABLE CONSULTAS (
	...
	,
	IdConsultaClinica INT FOREIGN KEY REFERENCES CLINICAS(ClinicaId)
	,
